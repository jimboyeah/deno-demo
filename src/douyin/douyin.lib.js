...
exports.Ability = exports.DouYinSdk = void 0;
/**
 * 开放平台用户类型：
 *
 *    - 普通用户
...
var DouYinSdk = /** @class */ (function () {
     ...
     * @memberof DouYinSdk
     */
    function DouYinSdk(clientKey, clientSecret) {
        ...
        var abi = [
            ...
            Ability.VideoList,
            Ability.VideoSearch,
            Ability.VideoComment,
            Ability.VideoDelete,
            Ability.Mobile,
        ];
        this.log(abi);
    }
    DouYinSdk.prototype.log = function () {
        var args = [];
...
(function (Ability) {
     ...
     */
    Ability["AwemeShare"] = "aweme.share";
    /**
     * 分享携带来源标签
     * - 分享携带来源标签，用户可点击标签进入转化页 特殊权限 默认关闭 管理中心申请
     */
    Ability["ShareWithSource"] = "share_with_source";
    /**
     * 分享给抖音好友
     * - 第三方App内容私信分享给抖音好友 普通权限 默认关闭 管理中心申请
     */
    Ability["ImShare"] = "im.share";
    /**
     * 授权登录 用抖音账号登录第三方平台
     * - 无需申请 默认开启
     * - 返回抖音用户公开信息 无需申请 默认开启
     */
    Ability["UserInfo"] = "user_info";
    /**
     * 静默授权
     * - 直接获取该用户的open id 特殊权限 默认关闭 管理中心申请
     */
    Ability["LoginID"] = "login_id";
    /**
     * 授权有效期动态续期
     * - refresh_token支持动态续期，每次续期+30天，续期次数上限为5次 普通权限 默认关闭 管理中心申请
     */
    Ability["RenewRefreshToken"] = "renew_refresh_token";
    /**
     * 用户管理
     * - 获取该用户的关注列表 普通权限 默认关闭 管理中心申请
     */
    Ability["FollowingList"] = "following.list";
    /**
     * - 获取该用户的粉丝列表 普通权限 默认关闭 管理中心申请
     */
    Ability["FansList"] = "fans.list";
    /**
     * 获取用户手机号
     * - 用抖音帐号登录第三方平台，获得用户在抖音上的手机号码 特殊权限 默认关闭 管理中心申请
     */
    Ability["Mobile"] = "mobile";
    Ability["MobileAlert"] = "mobile_alert";
    /**
     * 抖音视频发布及管理
     ...
     * - 发布携带小程序 无需申请 默认开启
     */
    Ability["VideoCreate"] = "video.create";
    /**
     * - 删除内容 普通权限 默认关闭 管理中心申请
     */
    Ability["VideoDelete"] = "video.delete";
    /**
     * - 查询授权用户的抖音视频数据 普通权限 默认关闭 管理中心申请
     */
    Ability["VideoData"] = "video.data";
    /**
     * - 查询特定抖音视频的视频数据 普通权限 默认关闭 管理中心申请
     */
    Ability["VideoList"] = "video.list";
    /**
     * 查询POI信息
     * - 查询地点信息，发布时携带位置标签 特殊权限 默认关闭 管理中心申请
     */
    Ability["PoiSearch"] = "poi.search";
    /**
     * 互动管理
     * - 评论管理（普通用户） 获取并管理评论 普通权限 默认关闭 管理中心申请
     */
    Ability["ItemComment"] = "item.comment";
    /**
     * 互动管理（企业号）
     * - 获取并管理评论（企业号） 普通权限 默认关闭 管理中心申请
     */
    Ability["VideoComment"] = "video.comment";
    /**
     ...
     */
    Ability["VideoSearch"] = "video.search";
    /**
     * 用户数据
     * - 查询用户的获赞、评论、分享，主页访问等相关数据 抖音数据权限 默认关闭 管理中心申请
     */
    Ability["DataExternalUser"] = "data.external.user";
    /**
     * 视频数据
     * - 查询作品的获赞，评论，分享等相关数据 抖音数据权限 默认关闭 管理中心申请
     */
    Ability["DataExternalItem"] = "data.external.item";
    /**
     * 粉丝画像数据
     * - 获取用户粉丝画像数据 抖音数据权限 默认关闭 管理中心申请
     */
    Ability["FansData"] = "fans.data";
    /**
     * 抖音热点
     * - 获取抖音热门内容 抖音数据权限 默认关闭 管理中心申请
     */
    Ability["HotSearch"] = "hotsearch";
    /**
     * 星图数据
     * - 星图达人与达人对应各指数评估分，以及星图6大热门维度下的达人榜单 抖音数据权限 默认关闭 管理中心申请
     */
    Ability["StarTops"] = "star_tops";
    Ability["StarTopScoreDisplay"] = "star_top_score_display";
    Ability["StarAuthorScoreDisplay"] = "star_author_score_display";
    /**
     * 抖音影视综榜单数据
     * - 查询抖音电影榜、抖音剧集榜、抖音综艺榜数据 定向开通 默认关闭 定向开通
     */
    Ability["DiscoveryEnt"] = "discovery.ent";
    /**
     * SDK分享视频数据
     * - 获取用户通过分享SDK分享视频数据 抖音数据权限 默认关闭 管理中心申请
     */
    Ability["DataExternalSdkShare"] = "data.external.sdk_share";
